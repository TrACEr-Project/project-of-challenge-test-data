...
load ('Simu_6meta_8time_beta03.mat','X_orig');
...
sub_normal=find(Y_rem.class{1,1}==2);
sub_abnormal=find(Y_rem.class{1,1}==1);
...
for kk=1:10
    ...
    R5_Results_CP_all_centered_test_100round.scoresMT{kk}=scores_M_T;
    R5_Results_CP_all_centered_test_100round.worstscoresMT(kk)=min(scores_M_T);
    R5_Results_CP_all_centered_test_100round.results{kk}=Results;
end
%%
save ('R5_Results_CP_all_centered_test_100round.mat','R5_Results_CP_all_centered_test_100round')


%% plot factors
load('R5_Results_CP_all_centered_test_100round.mat','R5_Results_CP_all_centered_test_100round')

for kk=1:10
    Results=R5_Results_CP_all_centered_test_100round.results{kk};
    for ii=1:10
